package code_setup.app_util.location_utils.geo_locator.tracking

import android.app.PendingIntent
import android.content.Context
import android.content.Intent
import code_setup.app_util.location_utils.getRes
...
import code_setup.app_util.location_utils.tracking.service.LocationTrackerUpdateBroadcastReceiver
import code_setup.app_util.location_utils.tracking.service.LocationTrackerUpdateIntentService
    ...
    fun requestLocationUpdates(context: Context, clasz: Class<*>) {
        ...
        try {
            ...
            LocationServices.getFusedLocationProviderClient(context).requestLocationUpdates(
                getLocationRequest(context), getTrackingPendingIntent(context)
            )
